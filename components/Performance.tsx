      ...
      <div id="container" className="container">
        ...
        {isHovered && (
          <div className="tooltip">
            This block shows the average statistics for the last 10 matches.
            Under each statistic there is a comparison with the average
            statistic for the last 100 matches.
            <br />
            <br />
            <span style={{ color: "green" }}>Green</span> is your statistic
            HIGHER than the average for the last 100 matches.
            <br />
            <span style={{ color: "red" }}>Red</span> is your statistic LOWER
            than the average for the last 100 matches.
          </div>
        )}
...
function getBarWidth(value: number, ranges: Range) {
  if (value >= ranges.red[0] && value <= ranges.red[1]) {
    ...
    return (
      ((value - ranges.yellow[0]) / (ranges.yellow[1] - ranges.yellow[0])) *
        33 +
      33
    );
  } else if (value >= ranges.green[0] && value <= ranges.green[1]) {
    return (
      ((value - ranges.green[0]) / (ranges.green[1] - ranges.green[0])) * 34 +
      66
    );
